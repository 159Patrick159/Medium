...
plot_gpr_samples(gpr_model=gp_RBF, n_samples=0, ax=ax[0])
plot_gpr_samples(gpr_model=gp_RQ, n_samples=0, ax=ax[1])
ax[0].plot(x_fine,HiddenFunc(x_fine),label='True Distribution')
ax[1].plot(x_fine,HiddenFunc(x_fine),label='True Distribution')
...
ax[0].legend()
ax[1].legend()
plt.savefig("GPR/Figures/GP And Sol.png")
#plt.show()
